...
if __name__ == '__main__':
    ...
    t_kmeans = TimeSeriesKMeans(n_clusters=clus_num, metric='dtw', max_iter=10, verbose=1)
    kmeans_res = t_kmeans.fit_predict(f_test)
    ...
    res_rdc_dim = pca_dim_rdc.fit_transform(f_test)
